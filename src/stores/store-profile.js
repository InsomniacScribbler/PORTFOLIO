...
export const useProfileStore = defineStore('profile', {
    state: () => ({
        component: 'Profile',
        username: 'InsomniacScribbler',
        org: 'aclc-iriga',
        name: 'Nikhil Singh',
        initial: 'N.',
        surname: 'Singh',
        social: {
            //facebook: 'https://www.facebook.com/InsomniacScribbler',
            github: 'https://github.com/InsomniacScribbler',
            twitter: 'https://twitter.com/singhNikhilzzz',
            linkedin: 'https://www.linkedin.com/in/nikhilzzz/'
        },
